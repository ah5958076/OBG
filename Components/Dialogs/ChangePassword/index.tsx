        ...
        <div id='dialogs' className={dialogStyles.dialogs}>
            ...
            <div id='dialog' className={`${dialogStyles.dialog} ${dialogStyles.show}`}>
                ...
                <form method="post" onSubmit={ changePasswordHandler } >
                    ...
                    <Input type='password' title='New Password *' icon={faKey} name='new_password' required={true} />
                    <Input type='password' title='Confirm Password *' icon={faKey} name='confirm_password' required={true} />
