...
const USER_ADDED="User inserted successfully";
...
const EXTENSION_NOT_ALLOWED="Only "+ALLOWED_EXTENSIONS+" extensions are allowed";
const VIDEO_EXTENSION_NOT_ALLOWED="Only "+ALLOWED_EXTENSIONS+","+ALLOWED_VIDEO_EXTENSIONS+" extensions are allowed";
...
const FANTASY_LEAGUE_ALREADY_EXISTS="Fantasy League against given name already exists";
...
const FANTASY_LEAGUE_NOT_UPDATED="Fantasy League not updated. Please try again";
const FANTASY_LEAGUE_UPDATED="Fantasy League updated successfully";
const FANTASY_LEAGUE_NOT_DELETED="Fantasy League not deleted. Please try again";
...
const GRAND_PRIX_ALREADY_EXISTS="Grand Prix against given name already exists";
...
const TOURNAMENT_ALREADY_EXISTS="Tournament against given name already exists";
...
module.exports={UNEXPECTED_ERROR,INVALID_PASSWORD, INVALID_USERNAME,FIELD_EMPTY, LOGIN_SUCCESS, USER_NOT_FOUND,USER_ALREADY_EXIST,USER_ADDED,USER_UPDATED,USER_DELETED,GAME_NOT_FOUND,GAME_ALREADY_EXIST,GAME_ADDED,GAME_UPDATED,GAME_DELETED,MAIL_SENT,CODE_EXPIRED,CODE_MATCHED,CODE_NOT_MATCHED,GAME_NOT_ADDED,IMAGE_NOT_UPLOADED,GAME_NOT_UPDATED,GAME_NOT_DELETED,GPLEAGUE_NOT_FOUND,GPLEAGUE_ALREADY_EXISTS,GPLEAGUE_NOT_ADDED,GPLEAGUE_ADDED,GPLEAGUE_NOT_UPDATED,GPLEAGUE_UPDATED,GPLEAGUE_NOT_DELETED,GPLEAGUE_DELETED,FANTASY_LEAGUE_NOT_FOUND,FANTASY_LEAGUE_ALREADY_EXISTS,FANTASY_LEAGUE_NOT_ADDED,FANTASY_LEAGUE_ADDED,FANTASY_LEAGUE_NOT_UPDATED,FANTASY_LEAGUE_UPDATED,FANTASY_LEAGUE_NOT_DELETED,FANTASY_LEAGUE_DELETED,TOURNAMENT_NOT_FOUND,TOURNAMENT_ALREADY_EXISTS,TOURNAMENT_NOT_ADDED,TOURNAMENT_ADDED,TOURNAMENT_NOT_UPDATED,TOURNAMENT_UPDATED,TOURNAMENT_NOT_DELETED,TOURNAMENT_DELETED,LADDER_NOT_FOUND,LADDER_ALREADY_EXISTS,LADDER_NOT_ADDED,LADDER_ADDED,LADDER_NOT_UPDATED,LADDER_UPDATED,LADDER_DELETED,LADDER_NOT_DELETED,INVENTORY_NOT_FOUND,INVENTORY_ALREADY_EXISTS,INVENTORY_NOT_ADDED,INVENTORY_ADDED,INVENTORY_NOT_UPDATED,INVENTORY_UPDATED,INVENTORY_DELETED,INVENTORY_NOT_DELETED,NEW_AND_CONFIRM_PASSWORD_ERROR,PASSWORD_CHANGED,PASSWORD_NOT_CHANGED,EXTENSION_NOT_ALLOWED,LOGOUT_SUCCESS,TEAM_NOT_FOUND,TEAM_ALREADY_EXIST,TEAM_ADDED,TEAM_UPDATED,TEAM_DELETED,TEAM_MEMBERS_EXCEED,VIDEO_NOT_UPLOADED,LADDER_RESULT_NOT_FOUND,LADDER_RESULT_ADDED,LADDER_RESULT_UPDATED,LADDER_RESULT_DELETED,TOURNAMENT_RESULT_NOT_FOUND,TOURNAMENT_RESULT_ADDED,TOURNAMENT_RESULT_UPDATED,TOURNAMENT_RESULT_DELETED,MATCH_RESULT_NOT_FOUND,MATCH_RESULT_ADDED,MATCH_RESULT_UPDATED,MATCH_RESULT_DELETED,MATCH_NOT_FOUND,MATCH_ADDED,MATCH_UPDATED,MATCH_DELETED,NO_DATA,NOTHING_TO_SHOW,GRAND_PRIX_ALREADY_EXISTS,GRAND_PRIX_NOT_FOUND,GRAND_PRIX_ADDED,GRAND_PRIX_DELETED,GRAND_PRIX_UPDATED, AUTH_FAILED, VIDEO_EXTENSION_NOT_ALLOWED};